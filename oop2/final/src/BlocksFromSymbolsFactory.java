    ...
    public void setblock(String s) throws IOException {
        ...
        if (s.contains("fill:")) {
            ...
            if (colorString.startsWith("image(")) {
                ...
                Image img = ImageIO.read(new File("resources/" + strimg));
        ...
        if (s.contains("fill-")) {
            ...
            if (colorString.startsWith("image(")) {
                c = c + 6;
                int e = s.indexOf(")", c);
                colorString = s.substring(c, e);

                Image img = ImageIO.read(new File("resources/" + colorString));
