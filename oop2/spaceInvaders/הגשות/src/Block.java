 ...
 */
    ...
    /**
     * @return Point place of middle block;
     */
        public Point getCenter() {
            int half = (int) this.width / 2;
            int x = (int) (this.getCollisionRectangle().getLowerLeft().getX() + half);
            int y = (int) (this.getCollisionRectangle().getLowerLeft().getY() + 10);
